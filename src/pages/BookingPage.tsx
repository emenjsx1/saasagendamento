          ...
          <CardContent className="p-3">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
              ...
              <div className="text-center md:text-left flex-grow">
                <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">{business.name}</h1>
                ...
                {business.address && (
                  <a 
                    ...
                    className="inline-flex items-center gap-2 text-xs text-gray-700 hover:text-primary transition-colors mb-2"
                  >
                ...
                <div className="flex flex-wrap items-center gap-2 justify-center md:justify-start">
                  {whatsappLink && (
                    <Button 
                      asChild 
                      size="sm"
                      className="bg-[#25D366] hover:bg-[#20BA5A] text-white h-8 text-xs"
                    >
