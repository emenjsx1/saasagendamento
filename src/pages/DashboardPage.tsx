...
const DashboardPage = () => {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 pb-6">
      <div className="w-full rounded-3xl bg-gradient-to-r from-black via-gray-900 to-gray-800 text-white p-3 sm:p-4 md:p-5 shadow-2xl">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
          <div>
            <p className="uppercase tracking-[0.4em] text-xs text-gray-400 mb-1.5">Painel Executivo</p>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold mt-1 mb-1.5">{business?.name || 'Seu Negócio'}</h1>
            <p className="text-gray-300 mt-1 max-w-2xl text-xs sm:text-sm leading-relaxed">
